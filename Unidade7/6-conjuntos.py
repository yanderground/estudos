...
Dito isso, na mesma forma que na matematica:

- Sets (conjuntos) não possuem valores suplicados;
- Sets (conjuntos) não possuem valores ordenados;
- Elementos não são acessados via índice, ou seja, conjuntos não são indexados;

Conjuntos são bons para se utilizar quando precisamos armazenas elementos
...
diferença entre Conjuntos (Sets) e Mapas (Dicionarios) em Pyhton:
...
# OBS: Ao criar um conjunto, caso seja adicionado um valor ja exitstente, o mesmo será ignorado
# sem gerar erros e nao fará parte do conjunto.
...
# Imagine que fizemos um formulario de cadastro de visitanes em uma feira ou museu e os visitantes
...
# OBS: Caso o valor não for encontrado, nenhum erro é gerado
...
# {'Julia', 'Gustavo', 'Ana', 'Marcos', 'Ellen', 'Pedro', 'Guilherme', 'Patricia', 'Fernando'}
print(unicos1)
